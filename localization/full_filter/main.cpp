    ...
    for (unsigned int t = 0; t < time_steps; t++) {
        ...
        */
        ...
        for (unsigned int i = 0; i < map_size; ++i) {
            ...
            std::vector<float> pseudo_range = pseudo_range_estimator(landmark_positions, pseudo_position);

            //TODO: get observation probability
            float observation_prob = observation_model(landmark_positions, observations, pseudo_range,
